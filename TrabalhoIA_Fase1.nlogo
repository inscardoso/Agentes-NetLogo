...
globals [bateria numMovimentos numContentores residuosGreen residuosYellow residuosPink residuosTotal residuosCleaner maxbateria maxdetritos tempCharging charging full]
...
; movimentação dos polluters
to movimentacao

  if shape = "person" [
    let adjacente-azul one-of neighbors4 with [pcolor = blue] ; neighbors4: Esta função devolve os quatro patches adjacentes (cima, baixo, esquerda, direita)
...
; descarregar residuos nos contentores
to descarregar
